...
RUN dnf update -y && \
    dnf install -y git make gcc clang libtool automake autoconf python-devel libcurl-devel zlib-devel readline-devel which libzip-devel diffutils libusbmuxd-devel openssl-devel pkg-config libusb1-devel
